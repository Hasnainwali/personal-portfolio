...
const About = () => {
  const text = `Crafting impactful digital experiences that
    ...
    strategy.`;
  const aboutText = `I'm a passionate full-stack developer who believes that great ideas deserve exceptional execution. With a background in building scalable web applications, eCommerce platforms, brand representation portfolios and marketing solutions, I help startups and businesses bring their visions to life — pixel by pixel, line by line.
